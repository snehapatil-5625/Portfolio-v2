...
const Navbar: React.FC = () => {
    ...
    return (
        <div className="fixed top-6 left-0 w-full z-[1000] flex justify-center px-6">
            <nav className={`w-full max-w-[1200px] transition-all duration-300 ease-in-out rounded-2xl border border-[var(--border-color)] ${scrolled ? 'bg-[var(--bg-card)]/80 backdrop-blur-md py-3 shadow-2xl' : 'bg-transparent py-5'
                }`}>
